    ...
    >
      ...
      <header className="flex justify-between items-center p-8 z-10 relative text-white">
        ...
        <nav className="flex gap-8">
          <a href="src/pages/index.jsx" className="hover:text-green-300 transition">
            Home
          </a>
          <Link href="/scan" className="hover:text-green-300 transition">
            Scan
          </Link>
          <Link href="/guide" className="hover:text-green-300 transition">
            Guide
          </Link>
          <Link href="/chatbot" className="hover:text-green-300 transition">
            Chatbot
          </Link>
      ...
      <section className="relative overflow-hidden py-16 md:py-24 lg:py-32 bg-[#1b3d32] text-white">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 flex flex-col md:flex-row-reverse">
          ...
          <div className="w-full md:w-1/2 lg:w-3/5 md:pl-12 lg:pl-24">
            <p className="text-sm font-semibold text-green-300 uppercase mb-2 tracking-wide">DEMI MASA DEPAN</p>
            <h2 className="text-4xl md:text-5xl font-bold leading-tight mb-8">Mari Kita Buat Bumi Yang Lebih Baik!</h2>
            <p className="text-lg text-gray-200 leading-relaxed mb-12">Lingkungan yang lebih baik dimulai dari kepedulian kita</p>
      ...
      <section className="bg-white py-16 md:py-24 text-gray-800">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-12">
            <p className="text-sm font-semibold text-green-600 uppercase mb-2 tracking-wide">FEATURED GUIDE</p>
            <h2 className="text-4xl md:text-5xl font-bold leading-tight">Panduan ini bisa bantu kamu beraksi untuk lingkungan</h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="relative h-64 w-full">
                ...
                <div className="absolute bottom-4 left-4 text-white">
                  <h3 className="font-bold text-2xl mb-1">
                    Organik <span className="inline-block transition-transform group-hover:translate-x-1">↗</span>
                  </h3>
            ...
            <div className="relative bg-gray-100 rounded-xl overflow-hidden shadow-md group">
              <div className="relative h-64 w-full">
                ...
                <div className="absolute bottom-4 left-4 text-white">
                  <h3 className="font-bold text-2xl mb-1">
                    Anorganik <span className="inline-block transition-transform group-hover:translate-x-1">↗</span>
                  </h3>
            ...
            <div className="relative bg-gray-100 rounded-xl overflow-hidden shadow-md group">
              <div className="relative h-64 w-full">
                ...
                <div className="absolute bottom-4 left-4 text-white">
                  <h3 className="font-bold text-2xl mb-1">
                    B3 <span className="inline-block transition-transform group-hover:translate-x-1">↗</span>
                  </h3>
            ...
            <div className="relative bg-gray-100 rounded-xl overflow-hidden shadow-md group">
              <div className="relative h-64 w-full">
                ...
                <div className="absolute bottom-4 left-4 text-white">
                  <h3 className="font-bold text-2xl mb-1">
                    Polypropylene (PP) <span className="inline-block transition-transform group-hover:translate-x-1">↗</span>
                  </h3>
