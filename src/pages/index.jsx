...
export default function Home() {
  ...
  return (
    ...
    >
      ...
      <section className="bg-white py-16 md:py-24 text-gray-800">
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Heading Block (Tidak berubah dari revisi sebelumnya) */}
        <div className="mb-12">
            <p className="text-base font-normal uppercase mb-2 tracking-wide text-green-800">FEATURED GUIDE</p>
            <h2 className="text-3xl font-semibold leading-tight text-gray-800">Panduan ini bisa bantu kamu beraksi untuk lingkungan</h2>
        </div>

        {/* Guide Cards Grid (Tidak berubah dari revisi sebelumnya) */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {/* Card 1: Organik (Tidak berubah) */}
            ...
            {/* Card 2: Anorganik (Tidak berubah) */}
            <div className="relative bg-gray-100 rounded-xl overflow-hidden shadow-lg group">
                <div className="relative h-64 w-full">
                    <Image
            ...
            {/* Card 4: Polyethylene Terephthalate (PETE) - REVISI JALUR GAMBAR */}
            <div className="relative bg-gray-100 rounded-xl overflow-hidden shadow-lg group">
                <div className="relative h-64 w-full">
                    <Image
                        // REVISI: Pastikan jalur ini benar-benar sesuai dengan lokasi file Anda di folder `public`
                        src="/images/pete-plastic.jpg" // Ubah dari "/images.jpegimages/pete-plastic.jpg"
            ...
            {/* Card 5: Polypropylene (PP) - REVISI JALUR GAMBAR */}
            <div className="relative bg-gray-100 rounded-xl overflow-hidden shadow-lg group">
                <div className="relative h-64 w-full">
                    <Image
                        // REVISI: Pastikan jalur ini benar-benar sesuai dengan lokasi file Anda di folder `public`
                        src="/images/pp-plastic.jpg" // Pastikan ini adalah jalur yang benar
