      ...
      <div className="flex">
        ...
        <main className="lg:ml-[350px] flex-1 h-[calc(100vh-4rem)] p-8 mb-30 xl:mr-[300px] z-1 bg-white relative top-20 ">
          <article className="selection:bg-green-700 selection:text-white text-gray-700">
            ...
            <ul className="list-disc list-inside space-y-2 text-gray-700 ml-5">
              <li>Sisa bahan radioaktif yang tidak terpakai atau kedaluwarsa (misalnya Technetium-99m, Iodine-131, Thallium-201, Fluorodeoxyglucose - FDG).</li>
        ...
        <Rightbar>
          <ul className="mb-8 space-y-3 ml-3 text-gray-600 text-sm">
            <li>
              <Link href="#overview" className="font-bold cursor-default">Limbah Radioaktif</Link>
            </li>
            <li>
