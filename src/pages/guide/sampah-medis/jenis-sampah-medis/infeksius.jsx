      ...
      <div className="flex">
        ...
        <main className="lg:ml-[350px] flex-1 h-[calc(100vh-4rem)] p-8 mb-30 xl:mr-[300px] z-1 bg-white relative top-20 ">
          <article className="selection:bg-green-700 selection:text-white text-gray-700">
            ...
            <ul className="list-disc list-inside space-y-2 text-gray-700 ml-5">
              <li>Penularan infeksi serius seperti Hepatitis B dan C, HIV/AIDS, TBC, dan infeksi lainnya kepada petugas medis, pasien, atau masyarakat umum jika tidak ditangani dengan benar.</li>
            </ul>
            <br />
            ...
            <ul className="list-disc list-inside space-y-2 text-gray-700 ml-5">
              ...
              <li>Peralatan medis bekas pakai yang terkontaminasi cairan tubuh (misalnya selang infus, kantung urin, kateter, tabung darah).</li>
              <li>Perban, kapas, kassa, atau sarung tangan bekas yang sudah bersentuhan dengan luka infeksius atau cairan tubuh pasien.</li>
        ...
        <Rightbar>
          <ul className="mb-8 space-y-3 ml-3 text-gray-600 text-sm">
            <li>
              <Link href="#overview" className="font-bold cursor-default">Limbah Infeksius</Link>
            </li>
            <li>
