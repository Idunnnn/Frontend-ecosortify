      ...
      <div className="flex">
        ...
        >
          <article className="selection:bg-green-700 selection:text-white text-gray-700">
            ...
            <Image src="/images/guide/manajemen-sampah.jpg" width={"550"} height={"500"} className="rounded-md my-5 mx-auto" />
            <p>
              Materi tentang sampah sangat penting untuk di ketahui. Selama manusia masih beraktivitas, sampah menjadi salah satu
              hal yang akan konsisten dihasilkan dan terus bertambah. Untuk itu diperlukan{" "}
              <strong>upaya penanganan sampah</strong> secara tepat dan bertanggung jawab agar volume sampah dapat dikurangi dan
              mencegahnya menumpuk mencemari lingkungan.
            </p>
            <br />
            <p>
              Lalu, bagaimana sebenarnya sampah didefinisikan atau diartikan? Apa saja ya hal terkait sampah yang perlu banyak
              orang ketahui?
            </p>
            <br />
            <p>
            ...
            <p>
              Dilihat dari wujudnya, sampah seringkali diartikan sebagai bahan atau material yang telah selesai digunakan dan
              tidak lagi memberi manfaat. Contohnya seperti sisa makanan berupa tulang yang bukan suatu hal yang penting lagi bagi
              manusia. Berikut adalah definisi sampah dari berbagai sumber.
            </p>
            <br />
            <p>
              <strong className="text-gray-700"> Menurut World Health Organization (WHO)</strong>, sampah adalah sesuatu yang
              tidak digunakan, tidak dipakai, tidak disenangi, atau sesuatu yang dibuang yang berasal dari kegiatan manusia dan
            ...
            <br />
            <p>
              Dilihat dari definisi di atas, dapat disimpulkan definisi sampah adalah sisa dari kegiatan sehari-hari manusia
              berupa material tertentu yang tidak lagi bisa dimanfaatkan sehingga harus dibuang dan dimusnahkan. Penanganan akhir
              sampah dilakukan bergantung pada karakteristik dan kategori setiap jenis sampah.
            </p>
            ...
            <Image src="/images/guide/sampah-organik.jpg" width={"550"} height={"500"} className="rounded-md my-5 mx-auto" />
            <p>
              Biasanya sampah jenis ini biasa kita kenal dengan sampah sisa makanan, potongan buah dan sayur, sampah dedaunan,
              pepohonan, dan rumput-rumputan, sekam padi, kotoran hewan ternak, juga potongan kuku dan helai rambut yang terbuang
              ke tanah.
            </p>
            <br />
            <p>
            ...
            <br />
            <p>
              Khusus untuk sampah tertentu, seperti daging, batok kelapa, kotoran, dan lainnya tidak dapat diolah atau
              dimanfaatkan kembali dengan alasan kesehatan atau karakteristiknya yang butuh waktu lama untuk terurai.{" "}
            </p>
            <br />
            <p>
            ...
            <p>
              ...
              tidak dapat terurai secara alami (undegradable) karena materialnya tidak berasal dari alam melainkan hasil olahan
              dari bahan sintetik tertentu.
            </p>
            <Image src="/images/guide/sampah-anorganik.jpg" width={"550"} height={"500"} className="rounded-md my-5 mx-auto" />
            <p>
              Beberapa contoh sampah anorganik yang sering dijumpai sehari-hari misalnya seperti kantong plastik, kaleng,
              aluminium, botol kaca, styrofoam, karton, tekstil dan masih banyak lagi. Barang-barang dengan material tersebut
              tidak dapat membusuk dengan bantuan alam, untuk itu harus diolah kembali oleh manusia atau mesin agar bisa
            ...
            <Image src="/images/guide/sampah-B3.jpeg" width={500} height={300} quality={50} className="rounded-md my-5 mx-auto" />
            <p>
            ...
            <br />
            <p>
              Beberapa contoh dari sampah B3 adalah sampah medis, seperti masker, jarum suntik, dan peralatan medis lainnya,
              sampah elektronik atau e-waste berupa lampu, kabel, gadget rusak, dan lainnya, cairan kimia dan pelumas, produk
              kadaluarsa, dan beberapa sampah lainnya dengan karakteristik mudah meledak, terbakar, bersifat korosif,
