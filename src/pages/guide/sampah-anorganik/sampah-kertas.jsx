      ...
      <div className="flex">
        ...
        <main className="lg:ml-[350px] flex-1 h-[calc(100vh-4rem)] p-8 mb-30 xl:mr-[300px] z-1 bg-white relative top-20 ">
          <article className="selection:bg-green-700 selection:text-white text-gray-700">
            ...
            <ol className="list-decimal list-inside space-y-2 text-gray-700">
              ...
              <li>
                <strong>Kertas Berlapis Plastik/Lilin:</strong> Misalnya bungkus permen atau biskuit bagian dalam, karton susu/minuman (kecuali ada program khusus). Lapisan ini mengganggu proses repulping.
              </li>
              <li>
            ...
            <ol className="list-decimal list-inside space-y-2 text-gray-700">
              <li>
                <strong>Pastikan Bersih dan Kering:</strong> Kertas harus kering dan relatif bersih dari kontaminasi seperti sisa makanan, minyak, atau kotoran. Kertas basah atau berminyak dapat merusak tumpukan kertas daur ulang lainnya dan menyebabkan jamur.
              </li>
              <li>
                <strong>Lipat atau Pipihkan:</strong> Untuk menghemat ruang, lipat atau pipihkan kardus dan kertas agar tidak memakan banyak tempat di wadah sampah atau saat dikumpulkan.
              </li>
              <li>
                <strong>Pisahkan dari Sampah Lain:</strong> Penting untuk memisahkan kertas dari sampah organik, plastik, atau logam. Kertas yang tercampur dengan sampah lain akan sulit dan mahal untuk disortir di fasilitas daur ulang.
              </li>
              <li>
                <strong>Bebaskan dari Pengikat:</strong> Jika ada staples, klip kertas, atau spiral plastik pada buku, lepas jika memungkinkan. Meskipun mesin daur ulang modern dapat menanganinya, melepasnya akan membantu.
              </li>
              <li>
                <strong>Serahkan ke Jalur yang Benar:</strong> Kumpulkan kertas yang sudah bersih dan terpilah. Kemudian, serahkan ke bank sampah, pengepul kertas bekas, atau tempat daur ulang khusus di kotamu. Jangan membuangnya ke tempat sampah umum yang bercampur.
              </li>
            </ol>
            <br />
            ...
            <ol className="list-decimal list-inside space-y-2 text-gray-700">
              <li>
                <strong>Pengumpulan & Penyortiran Awal:</strong> Sampah kertas dikumpulkan dari berbagai sumber dan disortir berdasarkan jenisnya (koran, kardus, HVS) dan kualitasnya. Pemisahan ini sangat penting untuk mendapatkan pulp yang sesuai standar.
              </li>
              <li>
                <strong>Pencacahan (Shredding) & Repulping:</strong> Kertas yang sudah disortir dimasukkan ke dalam mesin pencacah. Kemudian, potongan-potongan kertas ini dicampur dengan air dan bahan kimia di sebuah alat yang disebut pulper atau hydropulper. Proses ini akan melarutkan kertas menjadi bubur serat (pulp) yang kental.
              </li>
              <li>
                <strong>Pembersihan & Penghilangan Kontaminan:</strong> Pulp yang dihasilkan kemudian melewati berbagai tahapan pembersihan untuk menghilangkan kontaminan yang tidak larut, seperti plastik, lem, staples, dan kotoran lainnya. Ini bisa melibatkan penyaringan, sentrifugasi, atau proses flotasi.
              </li>
              <li>
                <strong>Penghilangan Tinta (De-inking):</strong> Untuk kertas yang memiliki tinta (seperti koran, majalah, atau HVS), proses de-inking dilakukan. Udara diinjeksikan ke dalam tangki berisi pulp dan bahan kimia, membuat gelembung yang mengangkat partikel tinta ke permukaan, yang kemudian bisa diangkat dan dibuang.
              </li>
              <li>
                <strong>Pemutihan (Opsional):</strong> Pulp yang sudah bersih mungkin perlu diputihkan untuk mencapai tingkat kecerahan yang diinginkan, terutama untuk produksi kertas putih berkualitas tinggi. Proses ini menggunakan bahan kimia tertentu.
              </li>
              <li>
                <strong>Pembentukan Lembaran Kertas Baru:</strong> Pulp yang sudah murni dan siap kemudian dialirkan ke mesin kertas raksasa. Di sini, pulp disebarkan secara merata di atas jaring bergerak, airnya dikeringkan, dan serat-seratnya saling mengikat membentuk lembaran kertas basah. Lembaran ini kemudian dikeringkan dan digiling untuk mendapatkan ketebalan dan kehalusan yang diinginkan.
              </li>
              <li>
                <strong>Penggunaan Kembali:</strong> Kertas daur ulang ini siap digunakan untuk membuat produk kertas baru seperti kardus, kertas koran, kertas toilet, tisu, paper bag, atau bahkan kertas cetak tertentu.
              </li>
            </ol>
            <br />
            <p>
              Dengan mendukung daur ulang kertas, kita tidak hanya mengurangi volume sampah, tetapi juga berkontribusi langsung pada perlindungan hutan dan pengurangan dampak lingkungan dari industri kertas.
            </p>
            <br />
        ...
        <Rightbar>
          <ul className="mb-8 space-y-3 ml-3 text-gray-600 text-sm">
            ...
            <li>
              <Link href="#jenis-umum" className="hover:font-semibold">Jenis Kertas yang Umum Ditemui</Link>
            </li>
            <li>
              <Link href="#tidak-didaur-ulang" className="hover:font-semibold">Jenis Kertas yang Tidak Dapat Didaur Ulang</Link>
            </li>
            <li>
              <Link href="#cara-penanganan" className="hover:font-semibold">Cara Penanganan Sampah Kertas oleh Individu</Link>
            </li>
            <li>
              <Link href="#proses-daur-ulang-industri" className="hover:font-semibold">Proses Pengolahan/Daur Ulang Kertas Industri</Link>
            </li>
          </ul>
        </Rightbar>
      </div>
