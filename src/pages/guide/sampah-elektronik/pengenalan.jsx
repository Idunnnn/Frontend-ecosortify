      ...
      <div className="flex">
        ...
        <main className="lg:ml-[350px] flex-1 h-[calc(100vh-4rem)] p-8 mb-30 xl:mr-[300px] z-1 bg-white relative top-20 ">
          <article className="selection:bg-green-700 selection:text-white text-gray-700">
            ...
            <h3 id="peralatan-hiburan" className="text-lg font-semibold mt-6 mb-2 text-green-700">2. Peralatan Hiburan &amp; Elektronik Konsumen</h3>
            <ul className="list-disc list-inside space-y-1 text-gray-700 ml-5">
            ...
            <h3 id="peralatan-tik" className="text-lg font-semibold mt-6 mb-2 text-green-700">3. Peralatan Teknologi Informasi dan Komunikasi (TIK)</h3>
            <ul className="list-disc list-inside space-y-1 text-gray-700 ml-5">
              <li>Ponsel (HP)</li>
            ...
            <h3 id="peralatan-listrik-komponen" className="text-lg font-semibold mt-6 mb-2 text-green-700">4. Peralatan Listrik dan Komponennya</h3>
            <ul className="list-disc list-inside space-y-1 text-gray-700 ml-5">
            ...
            <h3 id="perlengkapan-pencahayaan" className="text-lg font-semibold mt-6 mb-2 text-green-700">5. Perlengkapan Pencahayaan</h3>
            <ul className="list-disc list-inside space-y-1 text-gray-700 ml-5">
            ...
            <h3 id="mainan-alat-olahraga" className="text-lg font-semibold mt-6 mb-2 text-green-700">6. Mainan serta Alat Olahraga Elektronik</h3>
            <ul className="list-disc list-inside space-y-1 text-gray-700 ml-5">
            ...
            <p>
              Pengelompokan ini membantu kita memahami keragaman e-waste dan pentingnya membuangnya ke jalur yang tepat agar bisa didaur ulang atau ditangani dengan aman.
            </p>
            <br />
